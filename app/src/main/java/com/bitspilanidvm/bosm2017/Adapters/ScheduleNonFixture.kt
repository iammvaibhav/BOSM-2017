...
class ScheduleNonFixture(val data: List<NonFixtureSportsDataDecoupled>, val typeface: Typeface, val starClickListener: StarClickListener, val starred: ArrayList<String>, val name: String, val position: Int) : RecyclerView.Adapter<ScheduleNonFixture>(){
